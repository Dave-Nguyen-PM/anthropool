// Package store owns anthropool's state file (state.json) and the per-account
...
type State struct {
	...
	Sequence         []int           `json:"sequence"` // user-visible ordering for `anthropool switch` rotation
