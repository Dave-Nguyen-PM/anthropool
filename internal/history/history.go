// Package history is the persistent log of every account swap anthropool
// performs. Each Append writes one Entry to a JSON file under the anthropool
...
//
// The log is for the user's benefit — `anthropool history` shows it — and
...
const (
	TriggerManual    Trigger = "manual"     // user typed /switch or `anthropool switch`
